...
def convert_tf1_checkpoint_to_tf2(checkpoint_path: str, output_path: str):
    ...
    # Map TF1 variables to TF2 layers
    # This mapping is based on the Magenta onsets_frames_transcription model structure
    weight_mapping = {
        # Convolutional layers
        'onsets_frames/conv1/weights': 'conv1',
        'onsets_frames/conv1/biases': 'conv1',
        'onsets_frames/conv2/weights': 'conv2', 
        'onsets_frames/conv2/biases': 'conv2',
        'onsets_frames/conv3/weights': 'conv3',
        'onsets_frames/conv3/biases': 'conv3',
        
        # LSTM layers
        'onsets_frames/onset_bidirectional_rnn/fw/lstm_cell/kernel': 'onset_lstm',
        'onsets_frames/onset_bidirectional_rnn/fw/lstm_cell/bias': 'onset_lstm',
        'onsets_frames/onset_bidirectional_rnn/bw/lstm_cell/kernel': 'onset_lstm',
        'onsets_frames/onset_bidirectional_rnn/bw/lstm_cell/bias': 'onset_lstm',
        
        # Output layers
        'onsets_frames/onset_probs/weights': 'onset_probs',
        'onsets_frames/onset_probs/biases': 'onset_probs',
        'onsets_frames/offset_probs/weights': 'offset_probs',
        'onsets_frames/offset_probs/biases': 'offset_probs',
        'onsets_frames/velocity_values/weights': 'velocity_values',
        'onsets_frames/velocity_values/biases': 'velocity_values',
        'onsets_frames/frame_probs/weights': 'frame_probs',
        'onsets_frames/frame_probs/biases': 'frame_probs',
    }
    ...
    for var_name, shape in var_to_shape_map.items():
        try:
            ...
            if 'conv' in var_name or 'lstm' in var_name or 'probs' in var_name or 'values' in var_name:
    ...
    try:
        ...
        for layer in model.layers:
            if isinstance(layer, tf.keras.layers.Conv2D):
                ...
                for var_name, tensor in weights_dict.items():
                    if layer_name in var_name or (layer_name.replace('_', '') in var_name.replace('_', '')):
                        if 'weights' in var_name or 'kernel' in var_name:

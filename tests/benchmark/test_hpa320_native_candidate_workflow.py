...
WORKFLOW = REPOSITORY_ROOT / ".github/workflows/hpa320-native-candidate.yml"
...
def test_candidate_workflow_has_one_signed_native_work_job() -> None:
    _assert_native_workflow_contract(
        ...
        native_work_steps=(
            ...
            "Generate the sealed candidate without publishing it",
        ),
    )
